...
#define TOPICO_SUBSCRIBE    "/TEF/Transit003/cmd"        //tópico MQTT de escuta
#define TOPICO_PUBLISH      "/TEF/Transit003/attrs"      //tópico MQTT de envio de informações para Broker
#define TOPICO_PUBLISH_2    "/TEF/Transit003/attrs/p"    //tópico MQTT de envio de informações para Broker
                                                      //IMPORTANTE: recomendamos fortemente alterar os nomes
                                                      //            desses tópicos. Caso contrário, há grandes
                                                      //            chances de você controlar e monitorar o ESP32
                                                      //            de outra pessoa.
#define ID_MQTT  "Transit003"      //id mqtt (para identificação de sessão)
...
{   
  ...
  proximity = (duration / 2) * 0.0343;
    ...
    digitalWrite(TRIG_PIN, LOW);
    duration = pulseIn(ECHO_PIN, HIGH);
    proximity = 0.017 * duration;

    // Publica o valor da proximidade no tópico desejado
    char msgBuffer[10];
